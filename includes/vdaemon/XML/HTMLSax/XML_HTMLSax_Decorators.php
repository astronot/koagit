...
// +----------------------------------------------------------------------+
//
// $Id: XML_HTMLSax_Decorators.php,v 1.5 2003/10/08 10:14:51 harryf Exp $
//
/**
* Decorators for dealing with parser options
* @package XML_HTMLSax
* @version $Id: XML_HTMLSax_Decorators.php,v 1.5 2003/10/08 10:14:51 harryf Exp $
...
*/
if ((!function_exists('version_compare') || version_compare(phpversion(), '4.3', '<'))
