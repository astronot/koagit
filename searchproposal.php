...
<form method="post" name="form1" action="resultproposal.php">
	...
	<tr align="center">
		<td><br>
			...
			In: <select name="field" class="Menu">
                              <option value="prop_number" selected >Proposal #</option>
                              <option value="prop_name" >Proposal Name</option>
							  <option value="prop_req" >Requester</option>
				</select>
		<br><br></td>
	</tr>
