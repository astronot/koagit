...
$query_koa = "SELECT * FROM koa_project WHERE $field LIKE '%$data%' ORDER BY record_id ASC"; 
...
<?php do { ?>
              <tr>
              	<td> <a href="http://intranet/dev/koa/detailproject.php?recordID=<?php echo $row_koa['record_id']; ?>">Detail</a></td>
                <td> <?php echo $row_koa['proj_number']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['proj_name']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['proj_manager']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['proj_cliname']; ?>&nbsp; </td>
				<td> <?php echo $row_koa['proj_contact']; ?>&nbsp; </td>
				<td> <?php echo $row_koa['proj_req']; ?>&nbsp; </td>
              </tr>
