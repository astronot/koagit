...
$query_koa = "SELECT * FROM koa_proposal_archive WHERE prop_record_id = $recordID ORDER BY record_id ASC"; 
...
<table align="center" bgcolor="#CBDCEE" width="900" border="1" cellpadding="0" cellspacing="0" bordercolor="#E9F0F8">
		      ...
		      <td colspan="11"><br>
			  <strong>Record History</strong>(<?php echo $totalRows_koa; ?> total)
		     <br><br></td>
			  </tr>
			  <tr bgcolor="#8FB4DA">
...
<?php do { ?>
              <tr>
                ...
                <td> <?php echo $row_koa['prop_loc']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['prop_org']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['prop_manager']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['prop_cliname']; ?>&nbsp; </td>
                <td> <?php echo $row_koa['prop_cliadd']; ?>&nbsp; </td>
				<td> <?php echo $row_koa['prop_contact']; ?>&nbsp; </td>
				<td> <?php echo $row_koa['prop_desc']; ?>&nbsp; </td>
				<td> <?php echo $row_koa['prop_req']; ?>&nbsp; </td>
				<td> <?php echo $row_koa['prop_comments']; ?>&nbsp; </td>
              </tr>
