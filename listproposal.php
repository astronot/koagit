...
$query_koa = "SELECT * FROM koa_proposal ORDER BY record_id ASC"; 
...
<?php do { ?>
              <tr>
              	<td> <a href="http://intranet/koa/detailproposal.php?recordID=<?php echo $row_koa['record_id']; ?>">Detail</a> </td>
