...
if ((isset($row_koa['record_id'])) && ($row_koa['record_id'] != "")) { $record_id = $row_koa['record_id']; } else { $record_id = "No"; }
$timestamp = $timeSTMP;
?>
<?php
...
$mail->From = "$proj_reqemail";
$mail->FromName = "$proj_req";
$mail->AddAddress("pandp@krechojard.com", "New Project Notify List");
$mail->AddReplyTo("$proj_reqemail", "$proj_req");

$mail->WordWrap = 50;      		// set word wrap to 50 characters
$mail->IsHTML(true);          	// set email format to HTML

$mail->Subject = "NEW PROJECT - $proj_name";
$mail->Body    = "***********************************<br>* Date: <b>$proj_date</b><br>* Project Name:  <b>$proj_name</b><br>* Project Location:  <b>$proj_loc</b><br>* Organization:  <b>$proj_org</b><br>* Project Manager:  <b>$proj_manager</b><br>* Client Name:  <b>$proj_cliname</b><br>* Client Address:  <b>$proj_cliadd</b><br>* Client Contact:  <b>$proj_contact</b><br>* Invoice sent to same:  <b>$proj_invoice</b>  Attn:  <b>$proj_attn</b><br>* Terms of Contract:  <b>$proj_terms</b>  Contract Amount:  <b>$proj_contractamount</b><br>* Purchase Order:  <b>$proj_po</b>  PO #:  <b>$proj_ponumber</b><br>* Proposal or Contract on File:  <b>$proj_pocof</b><br>* Proposal #:  <b>$proj_propnumber</b><br>* Other Terms:  <b>$proj_othterms</b><br>* Project Description & Scope of Work:  <b>$proj_desc</b><br>* Requested by:  <b>$proj_req</b><br>* Comments:  <b>$proj_comments</b><br>* Additional Billing Groups:  <b>Subcontractors: $proj_billingsub  Reimbursables: $proj_billingreimb</b><br>***********************************<br><br>http://intranet/koa/enterproject.php?recordID=$record_id\n";
